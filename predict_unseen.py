...
import config
import data_utils
import extract_schema_embedding
import pred_utils
...
FLAGS = flags.FLAGS
print(config.DATASET_CONFIG.keys())
...
flags.DEFINE_enum("run_mode", "predict", ["train", "predict"],
...
flags.DEFINE_enum("dataset_split", "test_unseen", ["train", "dev", "test_seen", "test_unseen"],
